    ...
    foreach($datos as $rows){
        $tabla.='
            <tr class="has-text-centered" >
                ...
                <td>
                    <a href="index.php?vista=product_category&category_id='.$rows['categoria_id'].'" class="button is-link  is-small">Ver productos</a>
                </td>';
                
                if(!isset($busqueda) || $busqueda==""){
                    $tabla.='
                        <td>
                            <a href="index.php?vista=category_update&category_id_up='.$rows['categoria_id'].'" class="button is-success  is-small">Actualizar</a>
                        </td>
                        <td>
                            <a href="#"
                               class="button is-danger  is-small js-delete-button"
