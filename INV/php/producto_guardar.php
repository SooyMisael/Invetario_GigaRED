<?php
    ...
    $paquete=limpiar_cadena($_POST['producto_paquete']);


	/*== Verificando campos obligatorios ==*/
    if($codigo=="" || $nombre=="" || $precio=="" || $stock=="" || $categoria=="" || $detalle=="" || $proveedor=="" || $paquete==""){
        echo '
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_precio,producto_stock,producto_foto,producto_detalle,categoria_id, producto_proveedor,producto_paquete) VALUES(:codigo,:nombre,:precio,:stock,:foto,:detalle,:categoria, :proveedor, :paquete)");
